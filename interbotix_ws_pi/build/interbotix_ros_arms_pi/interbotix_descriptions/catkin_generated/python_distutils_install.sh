...
echo_and_run cd "/home/tx2-08/ROS-Projects/interbotix_ws/src/interbotix_ros_arms_pi/interbotix_descriptions"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tx2-08/ROS-Projects/interbotix_ws/src/interbotix_ros_arms_pi/interbotix_descriptions/setup.py" \
     \
    build --build-base "/home/tx2-08/ROS-Projects/interbotix_ws/build/interbotix_ros_arms_pi/interbotix_descriptions" \
    install \
    --root="${DESTDIR-/}" \
