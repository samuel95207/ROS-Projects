...
set(MSG_I_FLAGS "-Iinterbotix_diagnostic_tool:/home/locobot/ROS-Projects/interbotix_ws/src/interbotix_ros_arms/interbotix_examples/interbotix_diagnostic_tool/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/locobot/ROS-Projects/interbotix_ws/src/interbotix_ros_arms/interbotix_examples/interbotix_diagnostic_tool/msg/MotorTemps.msg" NAME_WE)
add_custom_target(_interbotix_diagnostic_tool_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "interbotix_diagnostic_tool" "/home/locobot/ROS-Projects/interbotix_ws/src/interbotix_ros_arms/interbotix_examples/interbotix_diagnostic_tool/msg/MotorTemps.msg" ""
)
...
_generate_msg_cpp(interbotix_diagnostic_tool
  "/home/locobot/ROS-Projects/interbotix_ws/src/interbotix_ros_arms/interbotix_examples/interbotix_diagnostic_tool/msg/MotorTemps.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/interbotix_diagnostic_tool)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/interbotix_diagnostic_tool\")")
  # install generated code
  install(
